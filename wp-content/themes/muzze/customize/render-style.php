<?php
function muzze_customize_css() {

    $layout_woo = include MUZZE_URL . '/customize/settings/layout-woo.php';
    $layout_global = include MUZZE_URL . '/customize/settings/layout-global.php';
    $general = include MUZZE_URL . '/customize/settings/general.php';
...
add_action('wp_enqueue_scripts', 'muzze_render_style');

function muzze_render_style(){
    wp_enqueue_style( 'ova-google-fonts', muzze_customize_google_fonts(), array(), null );
    wp_add_inline_style( 'muzze-style', muzze_customize_css() );
}

function muzze_customize_google_fonts(){
    ...
    $general_flag = _x( 'on', $primary_font_family.': on or off', 'muzze');
    $second_flag = _x( 'on', $second_font_family.': on or off', 'muzze');
