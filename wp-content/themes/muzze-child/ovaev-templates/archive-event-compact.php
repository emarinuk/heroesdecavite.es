...
<div class="container">
	...
	<div class="archive_event type3">
		...
		<?php if($events->have_posts() ) : while ( $events->have_posts() ) : $events->the_post(); ?>
            ...
            $event_duaration   = get_post_meta( $id, 'ovaev_duaration', true);
			...
			<div class="content">
				<div class="date-event">
					...
					<span class="month-year"><span class="month"><?php echo esc_html($month_event_M);?></span><span class="year"><?php echo esc_html($year_event);?></span></span>
				</div>
				<div class="desc">
					<div class="event-thumbnail" style="background: url(<?php echo esc_url($thumb_bgr);?>);"></div>
					<div class="event_post">
                        <?php if($event_duaration < 0){ ?>
