...
if ( ! defined( 'ABSPATH' ) ) {
	...
	wp_enqueue_script( 'qcld_hero_custom_partical_js', QCLD_SLIDERHERO_JS . "/particle_custom.js", array('jquery'));wp_enqueue_script( 'qcld_hero_custom_javascript', QCLD_SLIDERHERO_JS . "/hero_custom_script.js", array('jquery'), QCLD_HERO_VERSION);
	wp_enqueue_style( 'qcld_slider_hero_css_animate', QCLD_SLIDERHERO_CSS . "/animate.css");
	
	wp_enqueue_style( 'qcld_slider_hero_css', QCLD_SLIDERHERO_CSS . "/slider_hero.css", '', QCLD_HERO_VERSION);
	...
	if(isset($params->show_video_popup) && $params->show_video_popup==1){
		wp_enqueue_script( 'qcld_hero_magnific_javascript', QCLD_SLIDERHERO_JS . "/jquery.magnific-popup.js", array('jquery'));
		wp_enqueue_style( 'qcld_slider_hero_magnific_css', QCLD_SLIDERHERO_CSS . "/magnific-popup.css");
	}
	...
	if($_slider[0]->type=='cube_animation') :
	...
	if($_slider[0]->type=='flowingcircle') :
		...
		wp_localize_script( 'qcld_hero_flowingcircle_js', 'hcircle', array(
			'speed' => (isset($params->flowingcircle_speed)&&$params->flowingcircle_speed!=''?$params->flowingcircle_speed:10000),
			'animation'=> (isset($params->flowingcircle_animation)&&$params->flowingcircle_animation!=''?$params->flowingcircle_animation:0)
		) );
	...
	if($_slider[0]->type=='intro') :
		...
		wp_enqueue_script( 'qcld_hero_changethewords_js', QCLD_SLIDERHERO_JS . "/jquery.changethewords.js", array('jquery'), QCLD_HERO_VERSION);
	else:
		wp_enqueue_script( 'qcld_hero_slider_x_js', QCLD_SLIDERHERO_JS . "/jquery.slider_x.js", array('jquery'), QCLD_HERO_VERSION);
