<div class="othersetting">
	...
	<div class="params deseffect customitemstyle">
		...
		<select class="myElements" name="params[introbgeffect]">
			...
			<option value="stars" <?php echo (isset($params->introbgeffect) && $params->introbgeffect=='stars'?'selected="selected"':''); ?>>Stars Effect</option>
			
			<option value="ripples" <?php echo (isset($params->introbgeffect) && $params->introbgeffect=='ripples'?'selected="selected"':''); ?>>Ripples Effect</option>
			
			<option value="just_cloud" <?php echo (isset($params->introbgeffect) && $params->introbgeffect=='just_cloud'?'selected="selected"':''); ?>>Just Cloud</option>
			
			<option value="warp_speed" <?php echo (isset($params->introbgeffect) && $params->introbgeffect=='warp_speed'?'selected="selected"':''); ?>>Warp Speed</option>

			<option value="matrix" <?php echo (isset($params->introbgeffect) && $params->introbgeffect=='matrix'?'selected="selected"':''); ?>>Matrix Effect</option>
			
			<option value="colorful_particle" <?php echo (isset($params->introbgeffect) && $params->introbgeffect=='colorful_particle'?'selected="selected"':''); ?>>Colorful Particle</option>
			
			<option value="electric_clock" <?php echo (isset($params->introbgeffect) && $params->introbgeffect=='electric_clock'?'selected="selected"':''); ?>>Electric Clock</option>
			
			<option value="particle_snow" <?php echo (isset($params->introbgeffect) && $params->introbgeffect=='particle_snow'?'selected="selected"':''); ?>>Particle Snow</option>
			
			<option value="particle_system" <?php echo (isset($params->introbgeffect) && $params->introbgeffect=='particle_system'?'selected="selected"':''); ?>>Particle System</option>
			
			<option value="particle_bubble" <?php echo (isset($params->introbgeffect) && $params->introbgeffect=='particle_bubble'?'selected="selected"':''); ?>>Particle Bubble</option>
			
			<option value="particle_nasa" <?php echo (isset($params->introbgeffect) && $params->introbgeffect=='particle_nasa'?'selected="selected"':''); ?>>Particle Nasa</option>
			
			<option value="link_particle" <?php echo (isset($params->introbgeffect) && $params->introbgeffect=='link_particle'?'selected="selected"':''); ?>>Link Particle</option>
			
			<option value="nyan_cat" <?php echo (isset($params->introbgeffect) && $params->introbgeffect=='nyan_cat'?'selected="selected"':''); ?>>Nyan Cat Effect</option>
