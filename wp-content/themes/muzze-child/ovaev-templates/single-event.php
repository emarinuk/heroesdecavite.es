...
<!--			</div>-->
		...
		<div class="event_content">
			<div class="row">
				...
				<div class="col-md-4">
                    <div class="image cartel-lateral"><?php the_post_thumbnail(); ?></div>
...
<!--								</li>-->
                                <?php if( $date_start != '' ) : ?>
								<li><span class="label"><strong>Fecha:</strong> <?php echo esc_html($date_start);?></span></li>
                                <?php endif; ?>
                                <?php if( $time_start != '' ) : ?>
                                <li><span class="label"><strong><?php esc_html_e('Time:','ovaev');?></strong> <?php echo esc_html($time_start);?></span></li>
                                <?php endif; ?>
								<?php if( $event_venue != '' ) : ?>
								<li><span class="label"><strong><?php esc_html_e( 'Venue:', 'ovaev' );?></strong> <?php echo esc_html($event_venue);?></span></li>
								<?php endif; ?>
<!--								--><?php //if( $event_duaration != '' ) : ?>
<!--								<li><span class="label">--><?php //esc_html_e( 'Duration:', 'ovaev');?><!-- --><?php //echo esc_html($event_duaration); ?><!--</span></li>-->
<!--								--><?php //endif; ?>
							</ul>
                            <?php if( $date_start != '' && $date_end != '' ) : ?>
                                <div class="calendar-sync">
							<span class="sync">
								<p><a href="http://addtocalendar.com/atc/google?utz=420&amp;uln=en-US&amp;vjs=1.5&amp;e[0][date_start]=<?php echo esc_html($date_start_cld);?>&amp;e[0][date_end]=<?php echo esc_html($date_end_cld);?>&amp;e[0][timezone]=<?php echo get_option('timezone_string'); ?>&amp;e[0][title]=<?php echo get_the_title();?>&amp;e[0][description]=<?php echo get_the_excerpt();?>&amp;e[0][location]=<?php echo esc_html($event_map_address);?>&amp;e[0][organizer]=<?php echo esc_html($event_name);?>&amp;e[0][organizer_email]=<?php echo esc_html($event_email);?>" target="_blank" rel="nofollow"><?php esc_html_e( 'Exportar a Google', 'ovaev' );?></a></p>
								<p><a href="http://addtocalendar.com/atc/ical?utz=420&amp;uln=en-US&amp;vjs=1.5&amp;e[0][date_start]=<?php echo esc_html($date_start_cld);?>&amp;e[0][date_end]=<?php echo esc_html($date_end_cld);?>&amp;e[0][timezone]=<?php echo get_option('timezone_string'); ?>&amp;e[0][title]=<?php echo get_the_title();?>&amp;e[0][description]=<?php echo get_the_excerpt();?>&amp;e[0][location]=<?php echo esc_html($event_map_address);?>&amp;e[0][organizer]=<?php echo esc_html($event_name);?>&amp;e[0][organizer_email]=<?php echo esc_html($event_email);?>" target="_blank" rel="nofollow"><?php esc_html_e( 'Exportar a iCal', 'ovaev' );?></a></p>
							</span>
                                </div>
                            <?php endif; ?>
