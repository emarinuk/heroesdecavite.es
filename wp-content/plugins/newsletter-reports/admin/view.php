        ...
        <form action="" method="post">
            ...
            <div class="tnp-cards-container">
                ...
                <div class="tnp-card">
                    ...
                    <div class="tnp-card-value">
                        <?php echo (int) $report->total ?>
                    </div>
                    <div class="tnp-card-description">Total subscribers targeted</div>
                </div>

                <div class="tnp-card">
                    <div class="tnp-card-icon"><div class="tnp-card-icon-preview"></div></div>
                    <div class="tnp-card-title">Opens</div>
                    <div class="tnp-card-value"><?php echo esc_html($report->open_rate); ?>%</div>

                    <div class="tnp-card-description">
                        <b><?php echo (int) $report->open_count ?></b> subscribers who opened your email
                    </div>
                </div>
                ...
                <div class="tnp-card">
                    ...
                    <div class="tnp-card-value">
                        <?php echo esc_html($report->click_rate); ?>%
                    </div>

                    <div class="tnp-card-description">
                        <b><?php echo (int) $report->click_count ?></b> subscribers who clicked a link in your email
                    </div>
                </div>
                ...
                <div class="tnp-card">
                    ...
                    <div class="tnp-card-value">
                        <?php echo esc_html($report->reactivity) ?>%
                    </div>
                    <div class="tnp-card-description">
                        <b><?php echo (int) $report->click_count ?></b> clicks out of
                        <b><?php echo (int) $report->open_count ?></b> opens
                    </div>
                </div>
            ...
            <div class="tnp-cards-container">
                ...
                <div class="tnp-card">
                    ...
                    <div class="tnp-card-value"><?php echo (int) $report->unsub_count ?></div>
                    <div class="tnp-card-description">
                        Cancellations started from this newsletter (cannot be always tracked)
                    </div>
                </div>
                ...
                <div class="tnp-card">
                    ...
                    <div class="tnp-card-value"><?php echo (int) $report->error_count ?></div>
                    <div class="tnp-card-description">
            ...
            <div class="tnp-cards-container">
                ...
                <div class="tnp-card">
                    ...
                    <div class="tnp-card-description">
                        Subscribers who clicked or opened on that day.  
                    </div>
