...
background: <?php echo $params->video_overlay_color; ?>;
<?php endif; ?>
<?php if(isset($params->video_overlay_opacity) && $params->video_overlay_opacity!=''): ?>
opacity: <?php echo $params->video_overlay_opacity; ?>;
<?php endif; ?>
}
...
#particles-js<?php echo intval($_id); ?> .slider-x-lead-title, #particles-js<?php echo intval($_id); ?> .hero_slider_button, #particles-js<?php echo intval($_id); ?> .slider-x-item-title{margin: 15px 0px;}
...
#particles-js<?php echo intval($_id); ?> .hero_slider_button{
...
#particles-js<?php echo intval($_id); ?> > img{
	position:absolute;
	z-index:1;
}
#particles-js<?php echo intval($_id); ?>{
...
}elseif($bg_image_url!='' and isset($params->bgimageeffect) and $params->bgimageeffect=='' and $_slider[0]->type!='video' and $_slider[0]->type!='youtube_video' and $_slider[0]->type!='vimeo_video' and @$params->video!='vimeo' and @$params->video!='custom' and @$params->video!='vimeo'){
?>
...
.slider-x-lead-title<?php echo intval($_id); ?>{
/*position: absolute;
...
.slider-x-item-title<?php echo intval($_id); ?>{
/*
position: absolute;
...
.hero_slider_btn<?php echo intval($_id); ?>{
	/*
	position:absolute;
...
.hero_slider_btn<?php echo intval($_id); ?> a{
	z-index: 9;
    position: relative;
}

.slider-x-item-title<?php echo intval($_id); ?> > p{
...
#particles-js<?php echo intval($_id); ?>::after {
...
#particles-js<?php echo intval($_id); ?> form {
  position: absolute;
  padding: 30px;
  width: 150px;
...
#particles-js<?php echo intval($_id); ?> label {
  display: block;
  text-align: center;
...
#particles-js<?php echo intval($_id); ?> input[type=range] {
  -webkit-appearance: none;
  margin-bottom: 18px;
  width: 100%;
}
#particles-js<?php echo intval($_id); ?> input[type=range]:focus {
  outline: none;
}
#particles-js<?php echo intval($_id); ?> input[type=range]::-webkit-slider-runnable-track {
  width: 100%;
  height: 2px;
  cursor: pointer;
  background: white;
}
#particles-js<?php echo intval($_id); ?> input[type=range]::-webkit-slider-thumb {
  height: 13px;
  width: 13px;
  border-radius: 50%;
  background: white;
...
#particles-js<?php echo intval($_id); ?> input[type=range]::-moz-range-track {
  width: 100%;
  height: 2px;
  cursor: pointer;
  background: white;
}
#particles-js<?php echo intval($_id); ?> input[type=range]::-moz-range-thumb {
  height: 16px;
  width: 16px;
  border-radius: 50%;
...
<?php if(isset($params->play_button_position_horizontal)&& $params->play_button_position_horizontal=='right'): ?>
left: 90% !important;
<?php endif; ?>
<?php if(isset($params->play_button_position_horizontal)&& $params->play_button_position_horizontal=='left'): ?>
left: 10% !important;
<?php endif; ?>

<?php if(isset($params->play_button_position_vertical)&& $params->play_button_position_vertical=='top'): ?>
top: 25% !important;
<?php endif; ?>

<?php if(isset($params->play_button_position_vertical)&& $params->play_button_position_vertical=='bottom'): ?>
top: 75% !important;
<?php endif; ?>
...
<?php if(isset($params->content_display_bottom)&& $params->content_display_bottom=='1'): ?>
.qcld_hero_content_area{display:none !important}
<?php endif; ?>

<?php if(isset($params->content_display_bottom)&& $params->content_display_bottom=='2'): ?>
@media only screen and (max-width: 767px) and (min-width: 320px){
  .qcld_hero_content_area{display:none !important}
  .hero-mobilecontent{display:block !important}
}
.hero-mobilecontent{display:none}
<?php endif; ?>
