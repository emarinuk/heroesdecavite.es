...
$titletag = ( isset( $params->titletag ) && $params->titletag != '' ? $params->titletag : 'h2' );
...
?>
	...
	<<?php echo $titletag ?> class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?>"><?php 
		$titletext = wp_unslash(($slide->title));
	...
	<<?php echo $titletag ?> class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?>">
		<svg class="hero_svg_style">
			<symbol id="s-text<?php echo $slide->id; ?>">
				<text text-anchor="middle" x="50%" y="80%"><?php echo wp_unslash(($slide->title)); ?></text>
			</symbol>
...
<div class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?> hero_glitch_header" id="hero-glitch">
	<<?php echo $titletag ?> class="glitched"><?php echo wp_unslash(($slide->title)); ?></<?php echo $titletag ?>>
</div>
...
<div class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?>" id="hero-shuffle" data-title="<?php echo wp_unslash(($slide->title)) ?>">
	<h1></h1>
</div>
<script type="text/javascript">


var shuffle_text ='<?php echo wp_unslash(($slide->title)) ?>';
...
<div class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?>" id="hero-rearrange">
	<h1><?php echo wp_unslash(($slide->title)) ?></h1>
</div>
...
<div class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?>">
	<span id="play_info_text" class="pre_play_info_text"><?php echo wp_unslash(($slide->title)); ?></span>
</div>
...
animateInfoTextIn();
//setTimeout(function() { setInterval(animateInfoTextIn2, 10000); }, 3000);
...
?>
<<?php echo $titletag ?> class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?> mast__text"><?php 
$titletext =wp_unslash(($slide->title));
...
?>
<<?php echo $titletag ?> class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?>" id="hero_multicolor"><?php 
$titletext =wp_unslash(($slide->title));
		$titletext = str_split_unicode($titletext,1);
		foreach($titletext as $k=>$v):
			echo '<span>'.($v).'</span>';
...
<div class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?> hero_prompt">
	<p><?php echo wp_unslash(($slide->title)); ?></p>
</div>
...
<<?php echo $titletag ?> class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?> flag"><?php echo trim(wp_unslash($slide->title)); ?></<?php echo $titletag ?>>
...
?>
<div class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?>">
	<<?php echo $titletag ?> class="slidingtext"><span><?php echo trim(wp_unslash($slide->title)); ?></span></<?php echo $titletag ?>>
</div>
<script type="text/javascript">
jQuery(document).ready(function($) {
...
<h2 class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?> clip-text clip-text_one"><?php echo wp_unslash(($slide->title)); ?></h2>
<script type="text/javascript">
...
<<?php echo $titletag ?> class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?>"><?php echo wp_unslash(($slide->title)); ?></<?php echo $titletag ?>>
<?php // code for Animated Fill Text effect
elseif(isset($params->titleffect) and $params->titleffect=='anim-text-flow'):
?>
<<?php echo $titletag ?> class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?>"><?php echo hero_anim_text_flow(wp_unslash(($slide->title))); ?></<?php echo $titletag ?>>
<?php else: ?>
	<?php if(isset($params->titlebgcolor) and $params->titlebgcolor!=''): ?>
	<<?php echo $titletag ?> class="slider-x-lead-title slider-x-lead-title<?php echo intval($_id); ?>"><span style="background-color:<?php echo $params->titlebgcolor; ?>;padding: 0px 10px;"><?php echo wp_unslash(($slide->title)); ?></span></<?php echo $titletag ?>>
	<?php else: ?>
