...
* Fix   - Added fix for the LiveCanvas page builder that uses &hellip; in query vars
...
* Fix   - Fixed bug with empty Parent filter label
* Fix   - Fixed bug with Elementor and Seo Description
* Fix   - Fixed bug with Elementor pagination e.g. "e-page-5dabfd1=2"ribute all="true" for the [fe_posts_found] shortcode that counts all posts for all Filter Sets on a page