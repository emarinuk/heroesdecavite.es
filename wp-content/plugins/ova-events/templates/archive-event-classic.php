			...
			foreach ($events_array as $key_event => $value) { ?>
				...
				<div class="content">
					<div class="date-event">
						<span class="date-month"><?php  echo ($value[0]['date_event']);?><span class="month"><?php  echo ($value[0]['month_event_F']);?></span></span>
						<span class="weekday second_font"><?php  echo ($value[0]['week_day']);?></span>					
					</div>
						...
						foreach ($value as $key1 => $value1) {
							...
							<div class="desc <?php echo esc_attr($class_extra);?>">
								...
								<div class="event_post">
                                    ...
                                    <?php if($value1['ovaev_venue'] == 'nada'){ ?>
