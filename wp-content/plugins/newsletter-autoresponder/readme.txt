...
* Fixed problem with multilanguage installation where the multilanguage oplugin has been deactivated
* Fixed messages on the align run
* WP 6.7.1 check

= 1.5.8 =

* WP 6.6.2 check
* Fixed restart on autoresponder list on subscriber details page

= 1.5.7 =

* Added note on series list
* Added note on rules
