...
function ovaframework_metaboxes_default() {
    ...
    /* ************************************************************************************/
        ...
        $page_settings = new_cmb2_box( array(
            ...
            $page_settings->add_field( array(
                ...
                'description' => esc_html__( 'Allow display title of page', 'ova-framework' ),
                'type'             => 'select',
    ...
    $general_settings = new_cmb2_box( array(
        ...
        if( has_filter( 'muzze_list_header' ) ){
            $general_settings->add_field( array(
                ...
                'type'             => 'select',
                'show_option_none' => false,
                'options'          => array_merge( array( 'global' => 'Global' ),  apply_filters('muzze_list_header', '') ),
                'default' => 'global'
                
            ));
        }

        if( has_filter( 'muzze_list_footer' ) ){
            $general_settings->add_field( array(
                ...
                'type'             => 'select',
                'show_option_none' => false,
                'options'          => array_merge( array( 'global' => 'Global' ),  apply_filters('muzze_list_footer', '')),
                'default' => 'global'

            ) );
        }

        if( has_filter( 'muzze_define_layout' ) ){
            $general_settings->add_field( array(
                ...
                'type'             => 'select',
                'show_option_none' => false,
                'options'          => array_merge( array( 'global' => 'Global' ),  apply_filters('muzze_define_layout', '')),
                'default' => 'global',
                
            ) );
        }

        if( has_filter( 'muzze_define_wide_boxed' ) ){
            $general_settings->add_field( array(
                ...
                'type'             => 'select',
                'show_option_none' => false,
                'options'          => array_merge( array( 'global' => 'Global' ),  apply_filters('muzze_define_wide_boxed', '')),
                'default' => 'global',
