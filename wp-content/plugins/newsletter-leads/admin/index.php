...
if (!$controls->is_action()) {
    ...
    if ($controls->is_action('save')) {
        ...
        if (!isset($controls->data['customfields'])) {
            $controls->data['customfields'] = [];
        }
            ...
            <div id="tabs">
                ...
                <div id="tabs-fields">
                        ...
                        <table class="widefat" style="width: auto;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php $controls->checkbox2('theme_field_name', '', ['title' => __('Show', 'newsletter')]); ?></td>
                                </tr>

                                <tr>
                                    <th><?php esc_html_e('Last name', 'newsletter') ?></th>
                                    <td><?php $controls->checkbox2('theme_field_surname', '', ['title' => __('Show', 'newsletter')]); ?></td>
                                </tr>
                                <tr>
                                    <th><?php esc_html_e('Gender', 'newsletter') ?></th>
                                    <td style="vertical-align: top">

                                        <?php $controls->checkbox2('theme_field_gender'); ?>
                    ...
                    <?php if ($is_all_languages) { ?>
                        <h3>Custom fields</h3>
                        <?php
                        $customfields = Newsletter::instance()->get_customfields_public();
                        ?>
