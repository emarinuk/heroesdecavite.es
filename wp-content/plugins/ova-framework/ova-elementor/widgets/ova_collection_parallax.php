...
class ova_collection_parallax extends Widget_Base {

	public function get_name() {
		return 'ova_collection_parallax';
	}

	public function get_title() {
		return __( 'Collection Parallax', 'ova-framework' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .ova-collection-parallax .item-collection .content .title a',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-collection-parallax .item-collection .content .title a' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-collection-parallax .item-collection .content .title a:hover' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .ova-collection-parallax .item-collection .content .title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'separator' => 'before',
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'label'    => __( 'Typography', 'ova-framework' ),
					'selector' => '{{WRAPPER}} .ova-collection-parallax .item-collection .content .date p',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-collection-parallax .item-collection .content .date p' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .ova-collection-parallax .item-collection .content .date' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'separator' => 'before',
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'label'    => __( 'Typography', 'ova-framework' ),
					'selector' => '{{WRAPPER}} .ova-collection-parallax .item-collection .content .desc p',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-collection-parallax .item-collection .content .desc p' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
						'{{WRAPPER}} .ova-collection-parallax .item-collection .content .desc' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'separator' => 'before',
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'label' => __( 'Typography', 'ova-framework' ),
					'selector' => '{{WRAPPER}} .ova-collection-parallax .item-collection .content .readmore a',
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
						'{{WRAPPER}} .ova-collection-parallax .item-collection .content .readmore a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'separator' => 'before',
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
						'{{WRAPPER}} .ova-collection-parallax .item-collection .content .readmore' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'separator' => 'before',
				]
			);
			...
			$this->start_controls_tabs( 'tabs_button_style' );
				...
				$this->add_control(
					...
					[
						...
						'default' => '',
						'selectors' => [
							'{{WRAPPER}} .ova-collection-parallax .item-collection .content .readmore a' => 'color: {{VALUE}};',
						],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'default' => '',
						'selectors' => [
							'{{WRAPPER}} .ova-collection-parallax .item-collection .content .readmore a' => 'background-color: {{VALUE}};',
						],
					]
				);
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'type' => Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-collection-parallax .item-collection .content .readmore a:hover' => 'color: {{VALUE}};',
							],
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'type' => Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-collection-parallax .item-collection .content .readmore a:hover' => 'background-color: {{VALUE}};',
							],
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .ova-collection-parallax .item-collection .content .readmore a:hover' => 'border-color: {{VALUE}};',
							],
						]
					);
			...
			$this->add_control(
				...
				[
					...
					'size_units' => [ 'px', '%' ],
					'selectors' => [
						'{{WRAPPER}} .ova-collection-parallax .item-collection .content .readmore a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
	...
	protected function render() {
		...
		?>
		<div class="ova-collection-parallax">
			<?php
				$i = 0;
				if ($collection->have_posts()) : while ($collection->have_posts()) : $collection->the_post();
			...
			?>
				...
				<article class="item-collection <?php echo esc_attr($class_odd_even) ?>" >
