        ...
        <form method="post" action="">
            ...
            <div id="tabs">
                ...
                <ul>
                    ...
                    <li><a href="#tabs-rules"><?php esc_html_e('Starting rules', 'newsletter') ?></a></li>
                    <li><a href="#tabs-completed"><?php esc_html_e('When completed', 'newsletter') ?></a></li>
                ...
                <div id="tabs-completed">
                    <p>Actions to be performed when a subscriber completes the series.</p>
                    <table class="form-table">
                        <tr>
                ...
                <div id="tabs-analytics">
                    ...
                    <p>
                        ...
                        On UTM parameters <code>{email_id}</code> and <code>{email_subject}</code> can be used to make them dynamic.<br>
                    </p>
