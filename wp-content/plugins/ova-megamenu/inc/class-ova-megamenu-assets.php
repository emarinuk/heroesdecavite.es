...
if( !class_exists( 'OVA_Megamenu_Assets' ) ){
	class OVA_Megamenu_Assets{
		...
		public function ova_megamenu_enqueue_scripts(){
			...
			wp_enqueue_script( 'ova_megamenu_script', OVA_MEGAMENU_PLUGIN_URI.'assets/script.js', array('jquery'),null,true );
			wp_enqueue_style( 'ova_megamenu_css', OVA_MEGAMENU_PLUGIN_URI.'assets/style.css', array(), null  );
			
			
		}

		public function ova_megamenu_enqueue_scripts_admin(){
			wp_enqueue_style( 'ova_megamenu_css_admin', OVA_MEGAMENU_PLUGIN_URI.'assets/admin_style.css', array(), null );
		}
