...
class NewsletterAutomated extends NewsletterAddon {
    ...
    function hook_admin_menu() {
        ...
        add_submenu_page('admin.php', 'Edit', 'Edit', 'exist', 'newsletter_automated_edit', function () {
            require __DIR__ . '/admin/edit.php';
        });
        add_submenu_page('admin.php', 'Edit Legacy', 'Edit Legacy', 'exist', 'newsletter_automated_editlegacy', function () {
            require __DIR__ . '/admin/editlegacy.php';
        });
        add_submenu_page('admin.php', 'Newsletters', 'Newsletters', 'exist', 'newsletter_automated_newsletters', [$this, 'menu_page_newsletters']);
        add_submenu_page('admin.php', 'Config', 'Config', 'exist', 'newsletter_automated_config', function () {
            require __DIR__ . '/admin/config.php';
        });
        add_submenu_page('admin.php', 'Template', 'Template', 'exist', 'newsletter_automated_template', function () {
            require __DIR__ . '/admin/template.php';
        });
        add_submenu_page('admin.php', 'Logs', 'Logs', 'exist', 'newsletter_automated_logs', function () {
    ...
    function create_email($channel, $last_run = null) {
        ...
        $email['subject'] = Newsletter::instance()->replace_date($email['subject']);
        $email['message'] = Newsletter::instance()->replace_date($email['message']);
    ...
    function get_channels() {
        ...
        foreach ($channels as $channel) {
            ...
            if (!is_array($channel->data)) $channel->data = []; // Installations with wwrong migrated data
        }
        return $channels;
    }
